// the piece of code that we require and things that we need to do in todo.js is written inside another file name controller 
// request from todo.js goes to the controller and the res from controller to todo.js
