...
class todo{
    static getTodos(){
   return new Promise((resolve,reject)=>{  //because it is asynchronous task and we want if the task is completed then to get data and if not we should get an error
    fs.readFile(
        filePath,
        {
            encoding:'utf-8'
